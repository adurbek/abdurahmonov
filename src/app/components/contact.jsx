...
function Contact() {
  ...
  return (
    <section
      id="contact"
      className="min-h-screen bg-gradient-to-br from-gray-900 to-black flex items-center justify-center py-16 px-4"
    >
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl">
        ...
        <div className="flex flex-col items-center justify-center">
          <div className="flex flex-wrap justify-center gap-6 mb-12">
            {[
              {
                href: "https://www.youtube.com/channel/UCKwkUCkEwmtmbL0-Hp09Lcw",
                icon: <FaYoutube />,
                label: "YouTube",
              },
              {
